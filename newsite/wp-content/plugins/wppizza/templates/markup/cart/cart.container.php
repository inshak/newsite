		...
		$markup['div_'] = '<div class="'.$container_class.'">';
			...
			if(wppizza_is_shop_open()){
				...
				*/
				...
				/*
					omit div entirely if no buttons are enabled 
					(i.e if diabling orders completely and empty cart button not enabled )
				*/
				if(!empty($checkout_button) || !empty($empty_cart_button) ){
