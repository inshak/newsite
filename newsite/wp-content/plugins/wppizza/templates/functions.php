...
/*
	...
	However, user-defined CONSTANTS you might want to set
	HAVE TO be added to your wp-config.php (i.e *not* in your functions.php)
*/
// uncomment below to verify this file is being read
