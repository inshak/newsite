...
class WPPIZZA_ADDITIVES{
    ...
    *******************/
	public function init_admin_lables(){
		/*titles/labels throughout class*/
		$this->submenu_page_header	=	apply_filters('wppizza_filter_admin_label_page_header_'.$this->class_key.'', __('Allergens','wppizza-admin') . ' / ' . __('Additives','wppizza-admin'). ' / ' . __('Food Type','wppizza-admin'));
