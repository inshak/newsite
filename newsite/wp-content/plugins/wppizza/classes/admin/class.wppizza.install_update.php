	...
	function install_options_pages_categories_caps(){
		...
		**************************/
		...
		/**************************
		 ...
		 - menu items 		 
		**************************/
		if(defined('WPPIZZA_INSTALL_NO_DEFAULTS') && WPPIZZA_INSTALL_NO_DEFAULTS === true){
			
			$default_options['order_settings']['orderpage'] = -1;
			$default_options['sizes'] = array();
			$default_options['allergens'] = array();
			$default_options['additives'] = array();
			$default_options['foodtype'] = array();			
			$default_options['layout'] = array();
			
			/**************************
				set global wppizza options to be able to use them now subsequently
			**************************/
