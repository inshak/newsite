		...
		foreach($this->registered_gateways as $wppizza_gateway_object){
			...
			**/
			...
			/******************************************
		 		GATEWAY UPDATE
			******************************************/
			if ($gateway_options_set != 0 && !empty($gateway_options_set['_gateway_version']) && version_compare( $wppizza_gateway_object->gatewayVersion, $gateway_options_set['_gateway_version'], '>' ) ) {
		...
		foreach($registered_gateways as $gateway_ident=>$gateway_object){
			...
			*/
			$this->registered_gateways->$gateway_ident->gatewaySettings['_gateway_sortorder']=array(
                            ...
                            'value' => ( empty($gateway_set_options['_gateway_sortorder']) ? 0 : $gateway_set_options['_gateway_sortorder']) ,
                            'type' => 'text_size_1',
                            'options' => '',
			...
			$this->registered_gateways->$gateway_ident->gatewaySettings['_gateway_label']=array(
                            'key' => '_gateway_label',
                            'value' => ( empty($gateway_set_options['_gateway_label']) ? '' : $gateway_set_options['_gateway_label']),
                            'type' => 'text',
                            'options' => '',
			...
			$this->registered_gateways->$gateway_ident->gatewaySettings['_gateway_additional_info']=array(
                            ...
                            'value' => ( empty($gateway_set_options['_gateway_additional_info']) ? '' : $gateway_set_options['_gateway_additional_info']),
                            'type' => 'textarea',
                            'options' => '',
                            'validateCallback' => 'wppizza_validate_string',
			...
			$this->registered_gateways->$gateway_ident->gatewaySettings['_gateway_logo']=array(
                            'key' => '_gateway_logo',
                            'value' => ( empty($gateway_set_options['_gateway_logo']) ? '' : $gateway_set_options['_gateway_logo']),
                            'type' => 'text_size_100',
                            'options' => '',
                            'validateCallback' => 'wppizza_validate_string',
			...
			$this->registered_gateways->$gateway_ident->gatewaySettings['_gateway_button']=array(
                            'key' => '_gateway_button',
                            'value' => ( empty($gateway_set_options['_gateway_button']) ? '' : $gateway_set_options['_gateway_button'] ),
                            'type' => 'text_size_100',
                            'options' => '',
                            'validateCallback' => 'wppizza_validate_string',
