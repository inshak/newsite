    ...
    ******************************************************/
	...
	function add_admin_shortcodes($atts){
		...
		/**********************************************
			...
			order_delete='1' 	(optional bool - allow order delete button (if user has privileges))						
			...
			example: [wppizza_admin type='admin_orderhistory' name='cname' unprotected='1' order_delete='1']
