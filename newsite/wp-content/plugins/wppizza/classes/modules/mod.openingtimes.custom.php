	...
	function wppizza_admin_section_opening_times_custom($field, $values = false, $key = false){
		...
		$str.="<div class='wppizza_option'>";
			...
			*/
			...
			$str.="<input name='".WPPIZZA_SLUG."[".$this->settings_page."][".$field."][date_formatted][".$key."]' size='10' type='text' class='wppizza-date-select' value='".$date_formatted."' />";
			...
			$str.="<input name='".WPPIZZA_SLUG."[".$this->settings_page."][".$field."][open][".$key."]' size='3' type='text' class='wppizza-time-select' value='". (!empty($values['open']) ? $values['open'] : '') ."' />";

			$str.="".__('To', 'wppizza-admin').":";
			$str.="<input name='".WPPIZZA_SLUG."[".$this->settings_page."][".$field."][close][".$key."]' size='3' type='text' class='wppizza-time-select' value='".(!empty($values['close']) ? $values['close'] : '')."' />";
