			...
			if($ff['type'] != 'tips'){
				...
				*/
				...
				if(in_array($ff['type'],array('text', 'email'))){
					...
					$formfields[$key]['field'] .= '' . $ff['label'] . '';
					$formfields[$key]['field'] .= '</label>';
					$formfields[$key]['field'] .= '<input id="'. $key .'" name="'. $key.'"  type="text" value="' . $ff['value'] . '" placeholder="' .$ff['placeholder'] . '"  ' . $ff['required_attribute'] . ' ' . $ff['autocomplete'] . ' />';
				}
				...
				if($ff['type']=='textarea'){
					...
					$formfields[$key]['field'] .= '' . $ff['label'] . '';
					$formfields[$key]['field'] .= '</label>';
					$formfields[$key]['field'] .= '<textarea id="'. $key .'" name="'. $key.'" placeholder="' .$ff['placeholder'] . '" ' . $ff['required_attribute'] . ' ' . $ff['autocomplete'] . '>' . $ff['value'] . '</textarea>';
				}
